...
<head>
<TITLE>管理中心 - <?php echo $this->data['sys_name'];?> - <?php echo $this->data['sys_ver'];?></TITLE>
...
<FRAME id=topFrame name=topFrame src="?c=Main&a=top" noResize scrolling=no>
<FRAMESET id=bodyFrame border=0 frameSpacing=0 frameBorder=NO cols=176,* noresize scrolling="yes">
<FRAME id=left name=left src="?c=Main&a=left" frameBorder=0 scrolling=yes>
<FRAME id=right name=right marginWidth=0 marginHeight=0 src="?c=Main&a=main" frameBorder=0 scrolling=yes>
</FRAMESET></FRAMESET>
